...
public class DebtCaseController {
    ...
    public ResponseEntity<List<DebtCase>> createDebtCase(@Valid
                                                         @Min(value = 1, message = "ID must be a non-negative integer and greater than 0")
                                                         @NotNull @PathVariable(name = "id") int id, @RequestParam(name = "file") MultipartFile file) throws CsvValidationException, IOException, InvalidFileFormatException {
    ...
    public ResponseEntity<String> deleteDebtCaseById(@Valid
                                                     ...
                                                     @Valid
                                                     @Min(value = 1, message = "ID must be a non-negative integer and greater than 0")
                                                     @NotNull @PathVariable(name = "creditorId") int creditorId) {
